...
rmt.getManga = (callback = () => {}) => {
  ...
  const listPromises = listChars.map((list) =>
    getSelectedListFromUrl(`${RMT}/manga-list/${list}`, undefined, '.style-list a', eachFunction));
